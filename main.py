...
PDF_FILES = {
    ...
    "Capitolul 2 P1": "cap2_1-30.pdf",
    "Capitolul 2 P2": "cap2_31-60.pdf",
    "Capitolul 2 P3": "cap2_61-90.pdf",
    "Capitolul 2 P4": "cap2_91-120.pdf",
    "Capitolul 2 P5": "cap2_121-150.pdf",
...
def main():
    st.set_page_config(page_title="Quiz Contabilitate Financiara", page_icon="📈", layout="wide")
